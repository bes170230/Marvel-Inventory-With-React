    ...
    return (
        <Box sx = {{display: 'flex'}}>
                ...
                sx ={open ? myStyles.appBarShift : myStyles.appBar}
                    ...
                    <Toolbar sx={myStyles.toolbar}>
                        <IconButton
                            ...
                            <Button sx={myStyles.toolbarButton} onClick={handleDialogOpen}>Create New Movie</Button>
                    <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labelledby = 'form-dialog-title'>
                        <DialogTitle id="form-dialog-title">Add A New Marvel Movie</DialogTitle>
                            <DialogContent>
                                <DialogContentText>Fill the entire form to create a Marvel movie</DialogContentText>
                                <MarvelForm />
                            </DialogContent>
                        <DialogActions>
            ...
            <Box sx={myStyles.content}>
                        <h1>Data</h1>
                        {/* TODO: Data Table Component will be placed here */}
                        <DataTable />
            </Box>
